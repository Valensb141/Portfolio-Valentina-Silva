...
export default function Home() {
  ...
  return (
    <>
      <Header tagtext='Diseñadora y desarrolladora de producto' id='home'/>
      <RoundedContainer
        borderRadius='rouded-container rouded-container__top'
        title="Hola, hello! I'm Valentina"
        tagtext='Or Tini, or Valen'
        text='I am a Valencia-based Industrial Design Engineer graduate with three years of experience in the graphic design industry. Additionally, I hold a postgraduate degree in Frontend Development, UX/UI Design, and Digital Marketing.'
      ...
      <div className='img__duo'>
        <img
          className='img__one'
          src={me}
          alt='Valentina dressed in black clothing, smiling with a colourfull background'
        />
        <img className='img__two' src={coffeeMe} alt='Valentina smiling with a yellow coffee cup in her hands' />
      </div>

      <a href='#section1'></a>
      <h2 className='seccion__title' id='web-portfolio'>
