        ...
        <div className={props.borderRadius} id={props.id}>
            <div className='content'>
                ...
                <div className={props.textAndBtn}>
                    <SpaceTextBlock  text={props.text} text2={props.text2} btn={props.btn} to={props.to}/>
                </div>
            ...
            <div className={props.contactInfo}> 
                ...
                <div className='social__btns'>
                    ...
                    <BtnLinkOrTag target="_blanc" type='btn btn__primary' text="Behance" to='https://www.behance.net/valentinasilvab' icon={<IconArrow />}/>
                </div>
