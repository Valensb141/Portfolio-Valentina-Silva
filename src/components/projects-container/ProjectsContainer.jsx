...
const ProjectsContainer = () => {
    return (
        <section className='projects'>
            <TextImgBlock direction='project__container__imgToRight' src={toDoTwo} title="To Do List App" description="Esta es la descripción" icon={<Js/>} icon1={<Html/>} icon2={<Css/>} showIcon='icon-circle' to={`/project-to-do`}/>
